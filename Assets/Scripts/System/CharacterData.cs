...
namespace ProjectCode
{
    ...
    public class CharacterData : HighlightableObject
    {
        ...
        public void Attack(CharacterData target, string selectedPart)
        {
            if (selectedPart == "Right")
            {
        ...
        public void AttackTriggered()
        {
            ...
            /*
            m_AttackCoolDown = Equipment.Weapon.Stats.Speed - (Stats.stats.agility * Equipment.Weapon.Stats.Speed);
            */
        }
