...
public class StatsDrawer : PropertyDrawer
{
    public override float GetPropertyHeight(SerializedProperty property, GUIContent label)
    {
        ...
        int lineCount = enumTypesCount + 5;
    ...
    public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
    {
        ...
        EditorGUI.PropertyField(currentRect, property.FindPropertyRelative(nameof(StatSystem.Stats.power)));
        ...
        */
        ...
        currentRect.x += currentRect.width;
        EditorGUI.LabelField(currentRect, "DamageBoost (%)", style);
