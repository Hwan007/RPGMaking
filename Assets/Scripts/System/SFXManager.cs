...
namespace ProjectCode 
{
    ...
    public class SFXManager : MonoBehaviour
    {
        ...
        public static AudioClip GetDefaultFireSound()
        {
            var clipArray = Instance.DefaultFireSound;
...
public class SFXManagerEditor : Editor
{
    ...
    SerializedProperty m_DefaultFireSoundProp;
    ...
    void OnEnable()
    {
        ...
        m_DefaultFireSoundProp = serializedObject.FindProperty(nameof(SFXManager.DefaultFireSound));
    ...
    public override void OnInspectorGUI()
    {
        ...
        EditorGUILayout.PropertyField(m_DefaultFireSoundProp, true);
